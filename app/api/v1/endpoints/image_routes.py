...
from app.services.ai.image.persistence import persist_generated_images
...
async def generate_ai_image(
    ...
    try:
        ...
        persisted_images: List[ImageGenImage] = await persist_generated_images(result.images)
